////
////  UICollectionView+TableFlip.swift
////  Aljoud
////
////  Created by Sayed Abdo on 28/09/2021.
////
//
//import UIKit
//
...
//            case bottom
//
//            func yPosition(tableView: UICollectionView) -> CGFloat {
//                switch self {
//
//                case .top:
...
//            case right
//
//            func xPosition(cell: UICollectionViewCell) -> CGFloat {
//                switch self {
//
//                case .left:
...
//
//    /// Animate the entire `UITableView` with a `CollectionViewAnimation.Table` animation.
//    ///
//    /// - Parameters:
...
//    func animate(animation: CollectionViewAnimation.Table, completion: (() -> Void)? = nil) {
//        switch animation {
//
...
//    ///   - completion: An optional callback for when the animation completes.
//    func animate(animation: CollectionViewAnimation.Cell, indexPaths: [IndexPath]? = nil, completion: (() -> Void)? = nil) {
//        switch animation {
//
...
//    }
//
//    func animateTableViewWithDirection(duration: TimeInterval, direction: CollectionViewAnimation.Table.AnimationDirection, completion: (() -> Void)? = nil) {
...
//fileprivate extension UICollectionView {
//
//    func animateTableCellsWithDirection(duration: TimeInterval, direction: CollectionViewAnimation.Cell.AnimationDirection, indexPaths:[IndexPath]?, completion: (() -> Void)? = nil) {
